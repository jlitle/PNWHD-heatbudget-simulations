...
#load data
exposure_df_hourly <- read.csv("unsteady_June25.csv", header = TRUE) #June 25 low tide aerial exposure
view(exposure_df_hourly)

#Template file only includes two lengths, expand to many lengths following this pipeline:
